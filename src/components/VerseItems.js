                ...
                <div className="card text-bg-dark m-auto p-sm-2 p-1 pb-0 rounded border-top-0 mt-0" >
                    <div className="card m-sm-auto m-0 mt-2 border-0 text-bg-dark bg-opacity-50 mb-4 w-100 p-sm-2 p-0" id='card2'>
                        <div className="card-body">
                            ...
                            <span className="badge bg-secondary  bg-opacity-25 py-2 px-1 rounded-5 text-white-50 fw-semibold ms-2 float-end" style={{ fontSize: '12px' }}>{articles3.id}</span><p className="card-text text-end lead mb-1" style={{ fontSize: '1.2rem' }}>&#9900; {articles3.content}</p>
